...
function frutasNoComercio(fruta) {
    switch (fruta) {
        case 'maçã':
...
console.log(frutasNoComercio('maçã'))
console.log(frutasNoComercio('kiwi'))
console.log(frutasNoComercio('melancia'))
console.log(frutasNoComercio('alcatra'))